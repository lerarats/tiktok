...
class UserProfileScreenOther extends StatefulWidget {
  final String userId;

  const UserProfileScreenOther({Key? key, required this.userId}) : super(key: key);

  @override
  _UserProfileScreenOtherState createState() => _UserProfileScreenOtherState();
}

class _UserProfileScreenOtherState extends State<UserProfileScreenOther> {
